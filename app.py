...
def generate_newsletter_html(m_stage, d_icao, d_city, d_fbo, d_time, a_icao, a_city, a_fbo, a_time, d_icon, d_msg, a_icon, a_msg, services, r_dep, r_arr):
    ...
    def ramp_label(status):
        ...
        return f'<div style="font-size:7px; color:{color}; font-weight:800; margin-top:6px; letter-spacing:0.5px; text-transform:uppercase;">• Plane-side access: {status}</div>'
