    ...
    if m_stage != "Trip Confirmation":
        ...
        <div style='margin-top:25px; border-collapse: separate; display: table; width: 100%;'>
            <div style='display: table-cell; width: 48%; padding:20px; background:#fcfcfc; border:1px solid #eee; border-radius:10px; border-top:4px solid {BRAND_COLOR};'>
                ...
                <span style='font-size:13px; color:#333; font-weight:500;'>{d_msg if d_msg else "Visual Conditions"}</span>
            </div>
            ...
            <div style='display: table-cell; width: 48%; padding:20px; background:#fcfcfc; border:1px solid #eee; border-radius:10px; border-top:4px solid {BRAND_COLOR};'>
                ...
                <span style='font-size:13px; color:#333; font-weight:500;'>{a_msg if a_msg else "Visual Conditions"}</span>
            </div>
        </div>"""
